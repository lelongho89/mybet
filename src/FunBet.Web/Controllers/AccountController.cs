...
using FunBet.Sessions;
using FunBet.Web.Controllers.Results;
using FunBet.Web.Models;
using FunBet.Web.Models.Account;
...
{
    public class AccountController : FunBetControllerBase
    {
